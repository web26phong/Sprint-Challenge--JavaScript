...
graduates.forEach(function(object){
  let i = object.university.indexOf("Uni");
  if (i > -1){
    unisWithUni.push(object);
  }
});
...
lowCaseAnimalNames = zooAnimals.map(function(object){
...
lowPopulationAnimals = zooAnimals.filter(function(object){
...
populationTotal = zooAnimals.reduce(function(accumulator, object){
